//
//  NewDestinationListingView.swift
//  ITour
//
//  Created by Wolf Trail on 28.08.2024.
//

import SwiftData
import SwiftUI

struct NewDestinationListingView: View {
...
#Preview {
    NewDestinationListingView(sort: SortDescriptor(\Destination.name))
}
